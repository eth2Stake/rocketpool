...
contract SafeStakeVault is SafeStakeBase, SafeStakeVaultInterface {
    ...
    function withdrawEther(uint256 _amount) override external onlyLatestNetworkContract {
        ...
        // Withdraw
        SafeStakeVaultWithdrawerInterface withdrawer = SafeStakeVaultWithdrawerInterface(msg.sender);
    ...
    function withdrawToken(address _withdrawalAddress, IERC20 _tokenAddress, uint256 _amount) override external onlyLatestNetworkContract {
        ...
        require(tokenContract.transfer(_withdrawalAddress, _amount), "SafeStake Vault token withdrawal unsuccessful");
