...
contract SafeStakeDAOProtocolSettingsDeposit is SafeStakeDAOProtocolSettings, SafeStakeDAOProtocolSettingsDepositInterface {

    // Construct
    constructor(SafeStakeStorageInterface _safeStakeStorageAddress) SafeStakeDAOProtocolSettings(_safeStakeStorageAddress, "deposit") {
        // Set version
        version = 2;
