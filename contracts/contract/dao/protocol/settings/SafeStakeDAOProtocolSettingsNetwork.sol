...
contract SafeStakeDAOProtocolSettingsNetwork is SafeStakeDAOProtocolSettings, SafeStakeDAOProtocolSettingsNetworkInterface {
    // Construct
    constructor(SafeStakeStorageInterface _safeStakeStorageAddress) SafeStakeDAOProtocolSettings(_safeStakeStorageAddress, "network") {
        // Set version
        version = 2;
