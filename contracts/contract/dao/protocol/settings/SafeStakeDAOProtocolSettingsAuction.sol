...
contract SafeStakeDAOProtocolSettingsAuction is SafeStakeDAOProtocolSettings, SafeStakeDAOProtocolSettingsAuctionInterface {

    // Construct
    constructor(SafeStakeStorageInterface _safeStakeStorageAddress) SafeStakeDAOProtocolSettings(_safeStakeStorageAddress, "auction") {
        // Set version
        version = 1;
