...
abstract contract SafeStakeDAOProtocolSettings is SafeStakeBase, SafeStakeDAOProtocolSettingsInterface {
    ...
    modifier onlyDAOProtocolProposal() {
        ...
        if(getBool(keccak256(abi.encodePacked(settingNameSpace, "deployed")))) require(getContractAddress("safeStakeDAOProtocolProposals") == msg.sender, "Only DAO Protocol Proposals contract can update a setting");
        _;
    }
