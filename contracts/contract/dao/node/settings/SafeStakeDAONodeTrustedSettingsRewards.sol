...
contract SafeStakeDAONodeTrustedSettingsRewards is SafeStakeDAONodeTrustedSettings, SafeStakeDAONodeTrustedSettingsRewardsInterface {

    using SafeMath for uint;

    // Construct
    constructor(SafeStakeStorageInterface _safeStakeStorageAddress) SafeStakeDAONodeTrustedSettings(_safeStakeStorageAddress, "rewards") {
        // Set version
        version = 2;
