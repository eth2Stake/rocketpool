...
contract SafeStakeDAONodeTrustedUpgrade is SafeStakeBase, SafeStakeDAONodeTrustedUpgradeInterface {
    ...
    function upgrade(string memory _type, string memory _name, string memory _contractAbi, address _contractAddress) override external onlyLatestContract("safeStakeDAONodeTrustedProposals", msg.sender) {
