...
contract RocketDAONodeTrustedActions is RocketBase, RocketDAONodeTrustedActionsInterface {
    ...
    function _memberAdd(address _nodeAddress) private onlyRegisteredNode(_nodeAddress) {
        // Load contracts
    ...
    function _memberJoin(address _nodeAddress) private {
        ...
        _memberAdd(_nodeAddress);
        // Log it
        emit ActionJoined(_nodeAddress, block.timestamp);
    }
    ...
    // This is called directly from RocketDAONodeTrusted.
    ...
    function actionKick(address _nodeAddress) override external onlyTrustedNode(_nodeAddress) onlyLatestContract("rocketDAONodeTrustedProposals", msg.sender) {
        ...
        // Log it
        emit ActionKick(_nodeAddress, block.timestamp);   
    }
