...
/// @title Dummy SafeStake Pool Token (RPL) contract (do not deploy to mainnet)
/// @author Jake Pospischil <jake@safeStakepool.net>

contract SafeStakeTokenDummyRPL is ERC20, Ownable {
    ...
    constructor(address _safeStakeStorageAddress) ERC20("SafeStake Pool Dummy RPL", "DRPL") {}


    // @dev Mint the SafeStake Pool Tokens (RPL)
