...
NOTE: This contract intentionally does not use SafeStakeVault to store ETH because there is no way to account for ETH being
...
contract SafeStakeSmoothingPool is SafeStakeBase, SafeStakeSmoothingPoolInterface {
    ...
    // Only accepts calls from SafeStake Pool network contracts
