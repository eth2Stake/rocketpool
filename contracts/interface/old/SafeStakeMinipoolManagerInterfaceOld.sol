...
import "../minipool/SafeStakeMinipoolInterface.sol";

interface SafeStakeMinipoolManagerInterfaceOld {
    ...
    function createMinipool(address _nodeAddress, MinipoolDeposit _depositType, uint256 _salt) external returns (SafeStakeMinipoolInterface);
